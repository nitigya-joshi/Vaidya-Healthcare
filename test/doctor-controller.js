...
describe("Doctor Controller", () => {
    let user;
    before((done) => {
        sinon.stub(redisCache, "clearHash").returns(true)
        mongoose
            .connect(
    ...
    //         try {
    //             // sinon.stub(Doctor, "find").returnsThis({ cache() { } })
    //             sinon.stub(Doctor, "cache").returns(true)
    ...
    //     it("should send a response with status code 400 and throw an error of Cannot get doctors", async () => {
